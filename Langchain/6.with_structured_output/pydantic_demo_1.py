...
class Review(BaseModel):
    ...
    sentiment : Literal["Pos", "Neg", "Ntl"] = Field(description= "Generate sentiment which is either positive, negative or neutral") # Can pass own keywords as well
    pros: Optional[list[str]] = Field(description="Write down all the pros inside a list")  # Might be optional - import from typing
    cons: Optional[list[str]] = Field(description="Write down all the pros inside a list")
